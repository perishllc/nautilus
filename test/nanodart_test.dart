...
void main() {
  ...
  group('nanodart tests', () {
    test('test seed to private key', () {
      expect(NanoKeys.seedToPrivate('E11A48D701EA1F8A66A4EB587CDC8808D726FE75B325DF204F62CA2B43F9ADA1', 0),
          '67EDBC8F904091738DF33B4B6917261DB91DD9002D3985A7BA090345264A46C6');
      expect(NanoKeys.seedToPrivate('E11A48D701EA1F8A66A4EB587CDC8808D726FE75B325DF204F62CA2B43F9ADA1', 1),
          '22EDDBF0D72E9A4232C3FE6689A6CB0A228C9ED822715A63E2F8644AA2C905A4');
    });

    test('test address from seed', () {
      const String privKey = '67EDBC8F904091738DF33B4B6917261DB91DD9002D3985A7BA090345264A46C6';
      expect(NanoAccounts.createAccount(NanoAccountType.BANANO, NanoKeys.createPublicKey(privKey)),
          'ban_1p95xji1g5gou8auj8h6qcuezpdpcyoqmawao6mpwj4p44939oouoturkggc');
      expect(NanoAccounts.createAccount(NanoAccountType.NANO, NanoKeys.createPublicKey(privKey)),
          'nano_1p95xji1g5gou8auj8h6qcuezpdpcyoqmawao6mpwj4p44939oouoturkggc');
    });

    test('test hex to byte array and back', () {
      const String hex = '67EDBC8F904091738DF33B4B6917261DB91DD9002D3985A7BA090345264A46C6';
      final Uint8List byteArray = NanoHelpers.hexToBytes('67EDBC8F904091738DF33B4B6917261DB91DD9002D3985A7BA090345264A46C6');
      expect(NanoHelpers.byteToHex(byteArray), hex);
    });

    test('test hex to binary and back', () {
      const String hex = '67EDBC8F904091738DF33B4B6917261DB91DD9002D3985A7BA090345264A46C6';
      final String binary = NanoHelpers.hexToBinary('67EDBC8F904091738DF33B4B6917261DB91DD9002D3985A7BA090345264A46C6');
      expect(NanoHelpers.binaryToHex(binary), hex);
    });

    test('test bigint to byte and back', () {
      final BigInt raw = BigInt.parse('1000000000000000000000000000000');
      final Uint8List byteRaw = NanoHelpers.bigIntToBytes(raw);
    ...
    test('test state block hash computation', () {
      // open state block
      const int accountType = NanoAccountType.NANO;
      ...
      expect(calculatedHash, 'FC5A7FB777110A858052468D448B2DF22B648943C097C0608D1E2341007438B0');
      // receive state block
      ...
      expect(calculatedHash, '597395E83BD04DF8EF30AF04234EAAFE0606A883CF4AEAD2DB8196AAF5C4444F');
      // send state block
      account = 'xrb_3igf8hd4sjshoibbbkeitmgkp1o6ug4xads43j6e4gqkj5xk5o83j8ja9php';
      ...
      calculatedHash = NanoBlocks.computeStateHash(accountType, account, previous, representative, balance, link);
      expect(calculatedHash, '128106287002E595F479ACD615C818117FCB3860EC112670557A2467386249D4');
      // change state block
      account = 'xrb_3igf8hd4sjshoibbbkeitmgkp1o6ug4xads43j6e4gqkj5xk5o83j8ja9php';
      ...
      calculatedHash = NanoBlocks.computeStateHash(accountType, account, previous, representative, balance, link);
      expect(calculatedHash, '2A322FD5ACAF50C057A8CF5200A000CF1193494C79C786B579E0B4A7D10E5A1E');
    });

    test('test block signature', () {
      const String privKey = '9F0E444C69F77A49BD0BE89DB92C38FE713E0963165CCA12FAF5712D7657120F';
      const String hash = 'AEC75F807DCE45AFA787DE7B395BE498A885525569DD614162E0C80FD4F27EE9';

      final String signature = NanoSignatures.signBlock(hash, privKey);
    ...
    test('Can turn a nano seed into a mnemonic phrase and back', () {
      const String seed = 'BE3E51EE51BAB11950B2495013512FEB110D9898B4137DA268709621CE2862F4';
      final List<String> expectedWordsOrdered = [
        'sail',
        'verb',
        'knee',
        'pet',
      ...
      final List<String> seedAsMnemonic = NanoMnemomics.seedToMnemonic(seed);
    ...
    test('Can turn a utf-8 string into a byte array and back', () {
      const String originalStr = 'bbedward';
      final Uint8List asBytes = NanoHelpers.stringToBytesUtf8(originalStr);
      expect(NanoHelpers.bytesToUtf8String(asBytes), originalStr);
    });
    test('Can concatenate byte arrays', () {
      final Uint8List hex1 = NanoHelpers.hexToBytes('CA02');
      final Uint8List hex2 = NanoHelpers.hexToBytes('F2D1');
      expect(NanoHelpers.byteToHex(NanoHelpers.concat([hex1, hex2])), 'CA02F2D1');
    });
    test('Can encrypt and decrypt a seed/private key', () {
      final Uint8List seed = NanoHelpers.hexToBytes('E11A48D701EA1F8A66A4EB587CDC8808D726FE75B325DF204F62CA2B43F9ADA1');
      const String password = 'abc123';
      // Encrypt seed
      final Uint8List encrypted = NanoCrypt.encrypt(seed, password);
      // Decrypt seed
      final Uint8List decrypted = NanoCrypt.decrypt(encrypted, password);
