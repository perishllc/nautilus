...
class PerishImpl implements Perish {
  final PerishPlatform _platform;
  factory PerishImpl(ExternalLibrary dylib) =>
      PerishImpl.raw(PerishPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory PerishImpl.wasm(FutureOr<WasmModule> module) =>
      PerishImpl(module as ExternalLibrary);
  PerishImpl.raw(this._platform);
  Future<int> getCounter({dynamic hint}) {
...
class PerishPlatform extends FlutterRustBridgeBase<PerishWire> {
  PerishPlatform(ffi.DynamicLibrary dylib) : super(PerishWire(dylib));
...
class PerishWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  PerishWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  PerishWire.fromLookup(
