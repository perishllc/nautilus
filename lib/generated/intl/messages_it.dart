...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountNameMissing":
            MessageLookupByLibrary.simpleMessage("Scegli un nome account"),
        ...
        "addAddress":
            MessageLookupByLibrary.simpleMessage("Aggiungi un indirizzo"),
        ...
        "addWatchOnlyAccountError": MessageLookupByLibrary.simpleMessage(
            "Errore durante l\'aggiunta dell\'account di sola visualizzazione: l\'account era nullo"),
        "addWatchOnlyAccountSuccess": MessageLookupByLibrary.simpleMessage(
            "Account di solo orologio creato con successo!"),
        "addWorkSource":
            MessageLookupByLibrary.simpleMessage("Aggiungi fonte di lavoro"),
        ...
        "askTracking": MessageLookupByLibrary.simpleMessage(
            "Stiamo per chiedere il permesso di \"tracciamento\", questo viene utilizzato *rigorosamente* per attribuire link/referenze e analisi minori (cose come il numero di installazioni, quale versione dell\'app, ecc.) Riteniamo che tu abbia diritto alla tua privacy e non siamo interessati a nessuno dei tuoi dati personali, abbiamo solo bisogno dell\'autorizzazione affinché le attribuzioni dei link funzionino correttamente."),
        "asked": MessageLookupByLibrary.simpleMessage("Chiesto"),
        "authConfirm": MessageLookupByLibrary.simpleMessage("Autenticazione"),
        "authError": MessageLookupByLibrary.simpleMessage(
            "Si è verificato un errore durante l\'autenticazione. Riprovare più tardi."),
        "authMethod":
        ...
        "badRepWarning": MessageLookupByLibrary.simpleMessage(
            "Avviso di cattivo rappresentante"),
        "badRepWarningLong": MessageLookupByLibrary.simpleMessage(
            "Il rappresentante prescelto non sembra essere in regola, ti preghiamo di considerare di cambiarlo per la salute della rete"),
        "badRepWarningShort": MessageLookupByLibrary.simpleMessage(
            "Il rappresentante scelto non sembra essere in regola, tocca qui per sceglierne uno nuovo"),
        ...
        "branchConnectErrorLongDesc": MessageLookupByLibrary.simpleMessage(
            "Sembra che non riusciamo a raggiungere l\'API Branch, di solito è causato da una sorta di problema di rete o da una VPN che blocca la connessione.\n\n Dovresti comunque essere in grado di utilizzare l\'app normalmente, tuttavia l\'invio e la ricezione di buoni regalo potrebbero non funzionare."),
        ...
        "changePasswordParagraph": MessageLookupByLibrary.simpleMessage(
            "Cambia la tua password esistente. Se non conosci la tua password attuale, fai la tua ipotesi migliore in quanto non è effettivamente necessario cambiarla (poiché hai già effettuato l\'accesso), ma ci consente di eliminare la voce di backup esistente."),
        "changePin": MessageLookupByLibrary.simpleMessage("Cambia pin"),
        "changePinHint": MessageLookupByLibrary.simpleMessage("Imposta spilla"),
        ...
        "changeSeed": MessageLookupByLibrary.simpleMessage("Cambia seme"),
        ...
        "connectionWarning":
            MessageLookupByLibrary.simpleMessage("Impossibile connettersi"),
        "connectionWarningBody": MessageLookupByLibrary.simpleMessage(
            "Non riusciamo a connetterci al back-end, questa potrebbe essere solo la tua connessione o se il problema persiste, il back-end potrebbe essere inattivo per manutenzione o addirittura un\'interruzione. Se è trascorsa più di un\'ora e continui ad avere problemi, invia una segnalazione in #bug-reports nel server discord @ chat.perish.co"),
        ...
        "connectionWarningBodyShort": MessageLookupByLibrary.simpleMessage(
            "Non riusciamo a connetterci al back-end"),
        ...
        "copyMessage": MessageLookupByLibrary.simpleMessage("Copia messaggio"),
        ...
        "copyXMRSeed":
            MessageLookupByLibrary.simpleMessage("Copia il seme di Monero"),
        ...
        "createPinHint":
            MessageLookupByLibrary.simpleMessage("Crea una spilla"),
        "createQR": MessageLookupByLibrary.simpleMessage("Crea codice QR"),
        "created": MessageLookupByLibrary.simpleMessage("creato"),
        "creatingGiftCard": MessageLookupByLibrary.simpleMessage(
            "Creazione di una carta regalo"),
        "cronFormatExplainer":
            MessageLookupByLibrary.simpleMessage("Specificato in formato CRON"),
        "currency": MessageLookupByLibrary.simpleMessage("Valuta"),
        "currencyMode": MessageLookupByLibrary.simpleMessage("Modalità valuta"),
        "currencyModeChange":
            MessageLookupByLibrary.simpleMessage("Cambio modalità valuta"),
        "currencyModeChangeWarning": MessageLookupByLibrary.simpleMessage(
            "Ricordati di cambiare il nodo in/da un nodo BANANO affinché la modifica abbia effetto! Puoi farlo nel menu delle impostazioni avanzate -> Cambia nodo."),
        ...
        "defaultGiftMessage": MessageLookupByLibrary.simpleMessage(
            "Scopri Nautilus! Ti ho inviato dei nano con questo link:"),
        ...
        "enableTracking":
            MessageLookupByLibrary.simpleMessage("Abilita il monitoraggio"),
        ...
        "enterFrequency":
            MessageLookupByLibrary.simpleMessage("Inserisci Frequenza"),
        "enterGiftMemo":
        ...
        "enterSplitAmount":
            MessageLookupByLibrary.simpleMessage("Inserisci l\'importo diviso"),
        ...
        "exchangeCurrency": MessageLookupByLibrary.simpleMessage("Scambia %2"),
        "exchangeNano": MessageLookupByLibrary.simpleMessage("Scambio NANO"),
        "existingPasswordHint": MessageLookupByLibrary.simpleMessage(
            "Immetti la password corrente"),
        "existingPinHint":
            MessageLookupByLibrary.simpleMessage("Inserisci il pin corrente"),
        "exit": MessageLookupByLibrary.simpleMessage("Esci"),
        "exportTXData":
            MessageLookupByLibrary.simpleMessage("Transazioni di esportazione"),
        ...
        "frequencyEmpty":
            MessageLookupByLibrary.simpleMessage("Inserisci una frequenza"),
        ...
        "giftCardCreationError": MessageLookupByLibrary.simpleMessage(
            "Si è verificato un errore durante il tentativo di creare un collegamento alla carta regalo"),
        "giftCardCreationErrorSent": MessageLookupByLibrary.simpleMessage(
            "Si è verificato un errore durante il tentativo di creare una carta regalo, IL LINK O IL SEED DELLA CARTA REGALO È STATO COPIATO NEGLI APPUNTI, I TUOI FONDI POSSONO ESSERE CONTENUTI IN ESSI A SECONDA DI COSA È ANDATO storto."),
        "giftCardInfoHeader": MessageLookupByLibrary.simpleMessage(
            "Informazioni sul foglio regalo"),
        ...
        "giftProcessError": MessageLookupByLibrary.simpleMessage(
            "Si è verificato un errore durante l\'elaborazione di questa carta regalo. Forse controlla la tua connessione e prova a fare nuovamente clic sul link del regalo."),
        "giftProcessSuccess": MessageLookupByLibrary.simpleMessage(
            "Regalo ricevuto con successo, potrebbe volerci un momento prima che appaia nel tuo portafoglio."),
        "giftRefundSuccess": MessageLookupByLibrary.simpleMessage(
            "Regalo rimborsato con successo!"),
        ...
        "handoff": MessageLookupByLibrary.simpleMessage("giù le mani"),
        ...
        "hideAccountsConfirmation": MessageLookupByLibrary.simpleMessage(
            "Sei sicuro di voler nascondere gli account vuoti?\n\nQuesto nasconderà tutti gli account con un saldo esattamente pari a 0 (esclusi gli indirizzi di monitoraggio e il tuo account principale), ma puoi sempre aggiungerli nuovamente in seguito toccando il pulsante \"Aggiungi account\""),
        "hideAccountsHeader":
            MessageLookupByLibrary.simpleMessage("Nascondere gli account?"),
        "hideEmptyAccounts":
        ...
        "imSure": MessageLookupByLibrary.simpleMessage("Sono sicuro"),
        ...
        "importGiftIntro": MessageLookupByLibrary.simpleMessage(
            "Sembra che tu abbia cliccato su un link che contiene alcuni NANO, per ricevere questi fondi abbiamo solo bisogno che tu finisca di configurare il tuo portafoglio."),
        "importGiftv2": MessageLookupByLibrary.simpleMessage(
            "Il link che hai cliccato contiene dei NANO, vorresti importarlo in questo portafoglio?"),
        "importHD": MessageLookupByLibrary.simpleMessage("Importa HD"),
        "importHDTrust":
            MessageLookupByLibrary.simpleMessage("Importa HD / Fidati"),
        "importSecretPhrase":
        ...
        "importSecretPhraseHint2": MessageLookupByLibrary.simpleMessage(
            "Inserisci di seguito la tua frase segreta di 12 o 24 parole. Ogni parola deve essere separata da uno spazio."),
        ...
        "importStandard":
            MessageLookupByLibrary.simpleMessage("Standard di importazione"),
        ...
        "introSkippedWarningContent": MessageLookupByLibrary.simpleMessage(
            "Abbiamo saltato il processo di introduzione per farti risparmiare tempo, ma dovresti eseguire immediatamente il backup del seme appena creato.\n\nSe perdi il seme perderai l\'accesso ai tuoi fondi.\n\nInoltre, il tuo passcode è stato impostato su \"000000\" che dovresti anche cambiare immediatamente."),
        "introSkippedWarningHeader":
            MessageLookupByLibrary.simpleMessage("Fai il backup del tuo seme!"),
        "invalidAddress":
            MessageLookupByLibrary.simpleMessage("Indirizzo invalido"),
        "invalidFrequency":
            MessageLookupByLibrary.simpleMessage("Frequenza non valida"),
        "invalidHeight":
            MessageLookupByLibrary.simpleMessage("Altezza non valida"),
        "invalidPassword":
            MessageLookupByLibrary.simpleMessage("Password Invalida"),
        "invalidPin": MessageLookupByLibrary.simpleMessage("Pin non valido"),
        "iosFundingMessage": MessageLookupByLibrary.simpleMessage(
            "A causa delle linee guida e delle restrizioni dell\'App Store iOS, non possiamo collegarti alla nostra pagina delle donazioni. Se desideri supportare il progetto, considera l\'invio all\'indirizzo del nodo nautilus."),
        ...
        "loginOrRegisterHeader":
            MessageLookupByLibrary.simpleMessage("Login o Registrati"),
        ...
        "looksLikeHdSeed": MessageLookupByLibrary.simpleMessage(
            "Questo sembra essere un seme HD, a meno che tu non sia sicuro di sapere cosa stai facendo, dovresti invece usare l\'opzione \"Importa HD\"."),
        "looksLikeStandardSeed": MessageLookupByLibrary.simpleMessage(
            "Questo sembra essere un seme standard, dovresti invece usare l\'opzione \"Importa standard\"."),
        ...
        "messageCopied":
            MessageLookupByLibrary.simpleMessage("Messaggio copiato"),
        ...
        "moreSettings":
            MessageLookupByLibrary.simpleMessage("Più configurazioni"),
        "nameEmpty": MessageLookupByLibrary.simpleMessage("Inserisci un nome"),
        "natricon": MessageLookupByLibrary.simpleMessage("Natricon"),
        "nautilusWallet":
            MessageLookupByLibrary.simpleMessage("Portafoglio Nautilus"),
        "nearby": MessageLookupByLibrary.simpleMessage("Qui vicino"),
        ...
        "nextPayment":
            MessageLookupByLibrary.simpleMessage("Prossimo pagamento"),
        ...
        "notificationWarning":
            MessageLookupByLibrary.simpleMessage("Notifiche disabilitate"),
        "notificationWarningBodyLong": MessageLookupByLibrary.simpleMessage(
            "Richieste di pagamento, Memo e Messaggi richiedono che le notifiche siano abilitate per funzionare correttamente poiché utilizzano il servizio di notifiche FCM per garantire la consegna dei messaggi.\n\nPuoi abilitare le notifiche con il pulsante in basso o ignorare questa scheda se non ti interessa utilizzare queste funzionalità."),
        ...
        "onboard": MessageLookupByLibrary.simpleMessage("Invita qualcuno"),
        ...
        "passwordCapitalLetter": MessageLookupByLibrary.simpleMessage(
            "La password deve contenere almeno 1 lettera maiuscola e minuscola"),
        "passwordDisclaimer": MessageLookupByLibrary.simpleMessage(
            "Non siamo responsabili se dimentichi la tua password e, in base alla progettazione, non siamo in grado di reimpostarla o modificarla per te."),
        "passwordIncorrect":
        ...
        "passwordTooShort":
            MessageLookupByLibrary.simpleMessage("La password è troppo corta"),
        ...
        "pinIncorrect": MessageLookupByLibrary.simpleMessage(
            "È stato inserito un PIN errato"),
        ...
        "pinsDontMatch":
            MessageLookupByLibrary.simpleMessage("I pin non corrispondono"),
        "plausibleDeniabilityParagraph": MessageLookupByLibrary.simpleMessage(
            "Questo NON è lo stesso pin che hai usato per creare il tuo portafoglio. Premere il pulsante informazioni per ulteriori informazioni."),
        "plausibleInfoHeader": MessageLookupByLibrary.simpleMessage(
            "Informazioni plausibili sulla negazione"),
        "plausibleSheetInfo": MessageLookupByLibrary.simpleMessage(
            "Imposta un pin secondario per la modalità di negazione plausibile.\n\nSe il tuo portafoglio viene sbloccato utilizzando questo pin secondario, il tuo seme verrà sostituito con un hash del seme esistente. Questa è una funzione di sicurezza destinata ad essere utilizzata nel caso in cui tu sia costretto ad aprire il tuo portafoglio.\n\nQuesto pin agirà come un pin normale (corretto) TRANNE quando sblocchi il tuo portafoglio, che è quando si attiverà la modalità di negazione plausibile.\n\nI tuoi fondi SARANNO PERSI entrando in modalità di negazione plausibile se non hai eseguito il backup del tuo seme!"),
        ...
        "purchaseCurrency": MessageLookupByLibrary.simpleMessage("Acquista %2"),
        ...
        "requestFrom": MessageLookupByLibrary.simpleMessage("Richiesta da"),
        "requestPayment":
        ...
        "requestSheetInfo": MessageLookupByLibrary.simpleMessage(
            "Richiedi un pagamento, con i messaggi crittografati End to End!\n\nRichieste di pagamento, promemoria e messaggi saranno ricevibili solo da altri utenti di nautilus, ma puoi utilizzarli per la tua conservazione anche se il destinatario non utilizza nautilus."),
        "requestSheetInfoHeader":
            MessageLookupByLibrary.simpleMessage("Richiedi Info Foglio"),
        ...
        "requireCaptcha": MessageLookupByLibrary.simpleMessage(
            "Richiedi CAPTCHA per richiedere la carta regalo"),
        "resendMemo": MessageLookupByLibrary.simpleMessage(
            "Invia nuovamente questo memo"),
        "resetAccountButton":
            MessageLookupByLibrary.simpleMessage("Reimposta account"),
        "resetAccountParagraph": MessageLookupByLibrary.simpleMessage(
            "Questo creerà un nuovo account con la password che hai appena impostato, il vecchio account non verrà eliminato a meno che le password scelte non siano le stesse."),
        "resetDatabase":
        ...
        "sendRequests":
            MessageLookupByLibrary.simpleMessage("Inviare richieste"),
        ...
        "set": MessageLookupByLibrary.simpleMessage("Impostare"),
        ...
        "setPin": MessageLookupByLibrary.simpleMessage("Imposta pin"),
        "setPinParagraph": MessageLookupByLibrary.simpleMessage(
            "Imposta o modifica il PIN esistente. Se non hai ancora impostato un PIN, il PIN predefinito è 000000."),
        "setPinSuccess": MessageLookupByLibrary.simpleMessage(
            "Il pin è stato impostato correttamente"),
        "setPlausibleDeniabilityPin":
            MessageLookupByLibrary.simpleMessage("Imposta Pin plausibile"),
        "setRestoreHeight": MessageLookupByLibrary.simpleMessage(
            "Imposta l\'altezza di ripristino"),
        ...
        "setXMRRestoreHeight": MessageLookupByLibrary.simpleMessage(
            "Imposta l\'altezza di ripristino XMR"),
        ...
        "shareApp": MessageLookupByLibrary.simpleMessage("Condividi %1"),
        "shareAppText": MessageLookupByLibrary.simpleMessage(
            "Dai un\'occhiata a %1! Un portafoglio mobile NANO premier!"),
        "shareLink": MessageLookupByLibrary.simpleMessage("Condividi link"),
        "shareMessage":
            MessageLookupByLibrary.simpleMessage("Condividi messaggio"),
        "shareNautilus":
        ...
        "showAccount": MessageLookupByLibrary.simpleMessage("Mostra conto"),
        "showAccountInfo":
            MessageLookupByLibrary.simpleMessage("Informazioni sull\'account"),
        "showAccountQR": MessageLookupByLibrary.simpleMessage(
            "Mostra il codice QR dell\'account"),
        "showAddress": MessageLookupByLibrary.simpleMessage("Mostra indirizzo"),
        "showContacts": MessageLookupByLibrary.simpleMessage("Mostra contatti"),
        "showFunding": MessageLookupByLibrary.simpleMessage(
            "Mostra banner di finanziamento"),
        "showLinkOptions": MessageLookupByLibrary.simpleMessage(
            "Mostra le opzioni di collegamento"),
        "showLinkQR": MessageLookupByLibrary.simpleMessage("Mostra link QR"),
        "showMoneroHeader":
            MessageLookupByLibrary.simpleMessage("Mostra Monero"),
        "showMoneroInfo":
            MessageLookupByLibrary.simpleMessage("Abilita sezione Monero"),
        "showQR": MessageLookupByLibrary.simpleMessage("Mostra il codice QR"),
        "showUnopenedWarning":
            MessageLookupByLibrary.simpleMessage("Avviso non aperto"),
        "simplex": MessageLookupByLibrary.simpleMessage("Simplex"),
        "social": MessageLookupByLibrary.simpleMessage("Sociale"),
        "someone": MessageLookupByLibrary.simpleMessage("qualcuno"),
        "spendCurrency": MessageLookupByLibrary.simpleMessage("Spendi %2"),
        "spendNano": MessageLookupByLibrary.simpleMessage("Spendi NANO"),
        "splitBill": MessageLookupByLibrary.simpleMessage("Fattura divisa"),
        "splitBillHeader":
            MessageLookupByLibrary.simpleMessage("Dividi una fattura"),
        "splitBillInfo": MessageLookupByLibrary.simpleMessage(
            "Invia un sacco di richieste di pagamento in una volta! Ad esempio, è facile dividere un conto in un ristorante."),
        ...
        "swapXMR": MessageLookupByLibrary.simpleMessage("Scambia XMR"),
        "swapXMRHeader": MessageLookupByLibrary.simpleMessage("Scambia Monero"),
        "swapXMRInfo": MessageLookupByLibrary.simpleMessage(
            "Monero è una criptovaluta incentrata sulla privacy che rende molto difficile o addirittura impossibile tracciare le transazioni. Nel frattempo NANO è una criptovaluta incentrata sui pagamenti che è veloce e senza commissioni. Insieme forniscono alcuni degli aspetti più utili delle criptovalute!\n\nUsa questa pagina per scambiare facilmente il tuo NANO con XMR!"),
        "swapping": MessageLookupByLibrary.simpleMessage("Scambio"),
        ...
        "trackingHeader": MessageLookupByLibrary.simpleMessage(
            "Autorizzazione al monitoraggio"),
        "trackingWarning":
        ...
        "unopenedWarningHeader":
            MessageLookupByLibrary.simpleMessage("Mostra avviso non aperto"),
        "unopenedWarningInfo": MessageLookupByLibrary.simpleMessage(
            "Mostra un avviso quando invii fondi su un conto non aperto, questo è utile perché la maggior parte delle volte gli indirizzi a cui invii avranno un saldo e l\'invio a un nuovo indirizzo potrebbe essere il risultato di un errore di battitura."),
        "unopenedWarningWarning": MessageLookupByLibrary.simpleMessage(
            "Sei sicuro che questo sia l\'indirizzo giusto?\nQuesto account sembra non essere aperto\n\nPuoi disabilitare questo avviso nel riquadro delle impostazioni in \"Avviso non aperto\""),
        ...
        "useAppRep":
            MessageLookupByLibrary.simpleMessage("Usa %1 rappresentante"),
        "useCurrency": MessageLookupByLibrary.simpleMessage("Usa %2"),
        "useNano": MessageLookupByLibrary.simpleMessage("Usa NANO"),
        "useNautilusRep":
            MessageLookupByLibrary.simpleMessage("Use Nautilus Rep"),
        "userAlreadyAddedError":
            MessageLookupByLibrary.simpleMessage("Utente già aggiunto!"),
        "userNotFound":
        ...
        "watchAccountExists":
            MessageLookupByLibrary.simpleMessage("Account già aggiunto!"),
        "watchOnlyAccount":
        ...
        "welcomeTextLogin": MessageLookupByLibrary.simpleMessage(
            "Benvenuto in Nautilus. Scegli un\'opzione per iniziare o scegli un tema usando l\'icona qui sotto."),
        "welcomeTextUpdated": MessageLookupByLibrary.simpleMessage(
            "Benvenuto in Nautilus. Per iniziare, crea un nuovo portafoglio o importane uno esistente."),
        "welcomeTextWithoutLogin": MessageLookupByLibrary.simpleMessage(
            "Per iniziare, crea un nuovo portafoglio o importane uno esistente."),
        "withAddress": MessageLookupByLibrary.simpleMessage("Con indirizzo"),
        "withFee": MessageLookupByLibrary.simpleMessage("Con Tariffa"),
        ...
        "xmrStatusConnecting":
            MessageLookupByLibrary.simpleMessage("Collegamento"),
        "xmrStatusError": MessageLookupByLibrary.simpleMessage("Errore"),
        "xmrStatusLoading":
            MessageLookupByLibrary.simpleMessage("Caricamento in corso"),
        "xmrStatusSynchronized":
            MessageLookupByLibrary.simpleMessage("Sincronizzato"),
        ...
        "yesterdayAt": MessageLookupByLibrary.simpleMessage("Ieri alle")
      };
}
