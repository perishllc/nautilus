...
class UsbSheet extends StatefulWidget {
  const UsbSheet({Key? key}) : super(key: key);

  @override
  UsbSheetState createState() => UsbSheetState();
}

class UsbSheetState extends State<UsbSheet> {
  @override
  Widget build(BuildContext context) {
    return _buildColumn();
  }
  ...
  void log(String info) {
    ...
    UIUtil.showSnackbar(info, context);
  }
