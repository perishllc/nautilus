...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "addressOrUserMissing" : MessageLookupByLibrary.simpleMessage("请输入用户名或地址"),
    ...
    "blockExplorerInfo" : MessageLookupByLibrary.simpleMessage("使用哪个区块浏览器显示交易信息"),
    ...
    "blockedInfo" : MessageLookupByLibrary.simpleMessage("通过任何已知的别名或地址屏蔽用户。任何消息、事务或来自它们的请求都将被忽略。"),
    ...
    "copyWalletAddressToClipboard" : MessageLookupByLibrary.simpleMessage("将钱包地址复制到剪贴板"),
    ...
    "currencyModeInfo" : MessageLookupByLibrary.simpleMessage("选择要显示金额的单位。\n1 nyano = 0.000001 NANO，或者 \n1,000,000 nyano = 1 NANO"),
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("欢迎来到Nautilus。当您收到或发送NANO时，交易将如下出现。"),
    ...
    "examplePayRecipientMessage" : MessageLookupByLibrary.simpleMessage("生日快乐！"),
    "examplePaymentExplainer" : MessageLookupByLibrary.simpleMessage("一旦你发送或收到付款请求，它们就会像这样显示在这里，卡片的颜色和标签表示状态。 \n\n绿色表示请求已付款。\n黄色表示请求/备忘录尚未付款/已读。\n红色表示请求尚未被读取或接收。\n\n 没有金额的中性色卡片只是信息。"),
    ...
    "examplePaymentIntro" : MessageLookupByLibrary.simpleMessage("一旦您发送或收到付款请求，它们将显示在此处："),
    "examplePaymentMessage" : MessageLookupByLibrary.simpleMessage("嘿怎么了？"),
    "examplePaymentPending" : MessageLookupByLibrary.simpleMessage("很多"),
    "examplePaymentPendingMemo" : MessageLookupByLibrary.simpleMessage("租"),
    ...
    "exampleRecRecipientMessage" : MessageLookupByLibrary.simpleMessage("煤气钱"),
    ...
    "fallbackInfo" : MessageLookupByLibrary.simpleMessage("Nautilus 服务器似乎已断开连接，发送和接收（无备忘录）应该仍然可以运行，但付款请求可能无法通过\n\n 稍后再回来或重启应用程序再试一次"),
    ...
    "favoriteNameMissing" : MessageLookupByLibrary.simpleMessage("为此收藏夹选择一个名字"),
    ...
    "importGift" : MessageLookupByLibrary.simpleMessage("你点击的链接包含一些 nano，你想把它导入这个钱包，还是退款给发送它的人？"),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("注销将从此设备中删除您的种子和所有与Nautilus相关的数据。如果您的种子代码没有备份，您将永远无法再次访问您的帐户"),
    ...
    "memoSentButNotReceived" : MessageLookupByLibrary.simpleMessage("备忘录已重新发送！如果仍未确认，则收件人的设备可能处于脱机状态。"),
    ...
    "needVerificationAlert" : MessageLookupByLibrary.simpleMessage("此功能要求您具有更长的交易历史记录，以防止垃圾邮件。\n\n或者，您可以显示二维码供他人扫描。"),
    "needVerificationAlertHeader" : MessageLookupByLibrary.simpleMessage("需要验证"),
    ...
    "notificationBody" : MessageLookupByLibrary.simpleMessage("打开Nautilus查看此交易"),
    "notificationHeaderSupplement" : MessageLookupByLibrary.simpleMessage("点击打开"),
    "notificationInfo" : MessageLookupByLibrary.simpleMessage("为了使此功能正常工作，必须启用通知"),
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("您以后打开Nautilus不再需要密码了。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("以后需要这个密码才能打开Nautilus。"),
    ...
    "paymentRequestMessage" : MessageLookupByLibrary.simpleMessage("有人要求你付款！查看付款页面了解更多信息。"),
    ...
    "rateTheAppDescription" : MessageLookupByLibrary.simpleMessage("如果你喜欢这个应用程序，可以考虑花点时间查看它，\n它确实有帮助，而且花费的时间不应超过一分钟。"),
    ...
    "receiveMinimumHeader" : MessageLookupByLibrary.simpleMessage("接收最低限度信息"),
    "receiveMinimumInfo" : MessageLookupByLibrary.simpleMessage("收取的最低金额。如果收到的金额低于此金额的付款或请求，则会被忽略。"),
    ...
    "registerUsernameHeader" : MessageLookupByLibrary.simpleMessage("注册一个用户名"),
    ...
    "removeBlockedConfirmation" : MessageLookupByLibrary.simpleMessage("您确定要解除封锁 %1 吗？"),
    ...
    "requestAmountConfirm" : MessageLookupByLibrary.simpleMessage("请求 %1 %2"),
    "requestError" : MessageLookupByLibrary.simpleMessage("请求失败：此用户似乎没有安装 Nautilus，或者禁用了通知。"),
    "requestPayment" : MessageLookupByLibrary.simpleMessage("申请付款"),
    "requestSendError" : MessageLookupByLibrary.simpleMessage("发送付款请求时出错，收款人的设备可能处于离线状态或不可用。"),
    "requestSentButNotReceived" : MessageLookupByLibrary.simpleMessage("请求重新发送！如果仍未确认，则收件人的设备可能处于脱机状态。"),
    ...
    "sendMemoError" : MessageLookupByLibrary.simpleMessage("发送包含交易的备忘录失败，他们可能不是Nautilus用户。"),
    ...
    "shareNautilusText" : MessageLookupByLibrary.simpleMessage("来试试Nautilus！ 一个卓越的NANO手机钱包！"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 NANO 成功传送到您的 Nautilus 钱包。\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("这个过程会将纸钱包的钱币转移到您的 Nautilus 钱包。\n\n请按 \"%1\" 键开始。"),
    "transferIntroShort" : MessageLookupByLibrary.simpleMessage("此过程会将资金从纸质钱包转移到您的Nautilus钱包。"),
    ...
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("验证并解锁 Nautilus"),
    ...
    "usernameAlreadyRegistered" : MessageLookupByLibrary.simpleMessage("您已经注册了用户名！目前无法更改您的用户名，但您可以自由地在其他地址下注册一个新用户名。"),
    ...
    "usernameInfo" : MessageLookupByLibrary.simpleMessage("挑选一个独特的 @username 让亲朋好友轻松找到你！\n\n拥有 Nautilus 用户名可在全局范围内更新用户界面，以反映您的新用户名。"),
    ...
    "usernameWarning" : MessageLookupByLibrary.simpleMessage("鹦鹉螺用户名是由 nano.to 提供的集中式服务"),
    "viewDetails" : MessageLookupByLibrary.simpleMessage("查看详情"),
    "votingWeight" : MessageLookupByLibrary.simpleMessage("投票比重"),
    "warning" : MessageLookupByLibrary.simpleMessage("警告"),
    "welcomeText" : MessageLookupByLibrary.simpleMessage("欢迎来到Nautilus。下一步，您可以创建新钱包或导入已有钱包。"),
