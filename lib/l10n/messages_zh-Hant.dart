...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "addressOrUserMissing" : MessageLookupByLibrary.simpleMessage("請輸入使用者名稱或地址"),
    ...
    "blockExplorerInfo" : MessageLookupByLibrary.simpleMessage("使用哪個塊資源管理器來顯示交易信息"),
    ...
    "blockedInfo" : MessageLookupByLibrary.simpleMessage("透過任何已知的別名或地址封鎖使用者。任何來自他們的消息，交易或請求都將被忽略。"),
    ...
    "copyWalletAddressToClipboard" : MessageLookupByLibrary.simpleMessage("將錢包地址複製到剪貼板"),
    ...
    "currencyModeInfo" : MessageLookupByLibrary.simpleMessage("選擇顯示金額的單位。\n1 尼亞諾 = 0.000001 納米, 或 \n100 萬尼亞諾 = 1 納米"),
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("歡迎來到 Nautilus。當您收到或發送 NANO 時，交易將顯示如下："),
    ...
    "examplePayRecipientMessage" : MessageLookupByLibrary.simpleMessage("生日快樂！"),
    "examplePaymentExplainer" : MessageLookupByLibrary.simpleMessage("當您發送或收到付款請求後，它們會像這樣顯示在這裡，並帶有顯示狀態的卡片的顏色和標籤。 \n\n綠色表示請求已付款。\n黃色表示請求/備忘錄尚未付款/讀取。\n紅色表示請求尚未讀取或接收。\n\n 沒有金額的中性彩色卡片只是消息。"),
    ...
    "examplePaymentFulfilledMemo" : MessageLookupByLibrary.simpleMessage("壽司"),
    "examplePaymentIntro" : MessageLookupByLibrary.simpleMessage("一旦您傳送或收到付款要求，它們就會顯示在這裡："),
    ...
    "examplePaymentPendingMemo" : MessageLookupByLibrary.simpleMessage("租金"),
    ...
    "exampleRecRecipientMessage" : MessageLookupByLibrary.simpleMessage("氣, 錢"),
    ...
    "fallbackInfo" : MessageLookupByLibrary.simpleMessage("Nautilus 服務器似乎斷開連接，發送和接收（沒有備忘錄）應該仍然可以運行，但付款請求可能無法通過\n\n 稍後再回來或重新啟動應用程式再試一次"),
    ...
    "favoriteRemoved" : MessageLookupByLibrary.simpleMessage("% 1 已從我的最愛中移除！"),
    ...
    "importGift" : MessageLookupByLibrary.simpleMessage("您點擊的鏈接包含一些納米，您要將其導入此錢包，還是將其退還給發送的人？"),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("本動作會刪除您在本裝置裡頭的種子及所有和 Nautilus 有關的資料。如果您的種子沒有備份，您將永遠無法存取您的帳戶"),
    ...
    "memoSentButNotReceived" : MessageLookupByLibrary.simpleMessage("備忘錄重新發送！如果仍未確認，則收件者的裝置可能處於離線狀態。"),
    ...
    "needVerificationAlert" : MessageLookupByLibrary.simpleMessage("此功能要求您擁有更長的交易歷史記錄，以防止垃圾郵件。\n\n或者，您可以顯示 QR 碼供某人掃描。"),
    "needVerificationAlertHeader" : MessageLookupByLibrary.simpleMessage("需要驗證"),
    ...
    "notificationInfo" : MessageLookupByLibrary.simpleMessage("為了使此功能正常工作，必須啟用通知"),
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("您日後啟動 Nautilus 時不用輸入密碼。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("以後需要這個密碼方可開啟 Nautilus。"),
    ...
    "paymentRequestMessage" : MessageLookupByLibrary.simpleMessage("有人要求您付款！查看付款頁面以獲取更多信息。"),
    ...
    "rateTheAppDescription" : MessageLookupByLibrary.simpleMessage("如果您喜歡該應用程序，請考慮花時間對其進行審查，\n它確實有幫助，不應該花費超過一分鐘。"),
    ...
    "receiveMinimumInfo" : MessageLookupByLibrary.simpleMessage("收到的最低金額。如果收到的付款或請求金額少於此金額，則會被忽略。"),
    ...
    "removeBlockedConfirmation" : MessageLookupByLibrary.simpleMessage("您確定要解除封鎖% 1 嗎？"),
    ...
    "requestError" : MessageLookupByLibrary.simpleMessage("要求失敗：此使用者似乎沒有安裝 Nautilus，或已停用通知。"),
    "requestPayment" : MessageLookupByLibrary.simpleMessage("請求付款"),
    "requestSendError" : MessageLookupByLibrary.simpleMessage("傳送付款要求時發生錯誤，收件人的裝置可能離線或無法使用。"),
    "requestSentButNotReceived" : MessageLookupByLibrary.simpleMessage("請求重新發送！如果仍未確認，則收件者的裝置可能處於離線狀態。"),
    ...
    "shareNautilusText" : MessageLookupByLibrary.simpleMessage("請試試 Nautilus —— 針對行動裝置的 NANO 錢包！"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 NANO 順利移轉到您的 Nautilus 錢包。\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("這過程會將紙錢包的資產移轉至您的 Nautilus 錢包。\n\n輕觸 \"%1\" 按鈕開始。"),
    "transferIntroShort" : MessageLookupByLibrary.simpleMessage("這個過程會將資金從紙錢包轉移到您的 Nautilus 錢包。"),
    ...
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("經由生物辨識解鎖 Nautilus"),
    ...
    "usernameAlreadyRegistered" : MessageLookupByLibrary.simpleMessage("您已經註冊了用戶名！目前無法更改您的用戶名，但您可以在其他地址下自由註冊一個新的用戶名。"),
    ...
    "usernameInfo" : MessageLookupByLibrary.simpleMessage("挑選一個獨特的 @username，讓朋友和家人都能輕鬆找到你！\n\n擁有 Nautilus 使用者名稱會在全球範圍內更新使用者介面，以反映您的新帳號。"),
    ...
    "usernameWarning" : MessageLookupByLibrary.simpleMessage("Nautilus 用戶名是 Nano.by 提供的集中式服務"),
    "viewDetails" : MessageLookupByLibrary.simpleMessage("更多資訊"),
    "votingWeight" : MessageLookupByLibrary.simpleMessage("投票比重"),
    "warning" : MessageLookupByLibrary.simpleMessage("警告"),
    "welcomeText" : MessageLookupByLibrary.simpleMessage("歡迎來到 Nautilus。接著您可建立新錢包或匯入現有錢包"),
