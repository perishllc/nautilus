...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "addressMissing": MessageLookupByLibrary.simpleMessage("Παρακαλούμε εισάγετε μια διεύθυνση"),
        "addressShare": MessageLookupByLibrary.simpleMessage("Κοινοποίηση"),
        ...
        "biometricsMethod": MessageLookupByLibrary.simpleMessage("Βιομετρία"),
        ...
        "contactRemoved": MessageLookupByLibrary.simpleMessage("Ο/Η %1 διαγράφηκε από τις επαφές!"),
        "contactsHeader": MessageLookupByLibrary.simpleMessage("Επαφές"),
        "contactsImportErr": MessageLookupByLibrary.simpleMessage("Η εισαγωγή των επαφών απέτυχε"),
        "contactsImportSuccess": MessageLookupByLibrary.simpleMessage("Εισάχθηκαν επιτυχώς %1 επαφές"),
        ...
        "exampleCardFrom": MessageLookupByLibrary.simpleMessage("από κάποιον/α"),
        "exampleCardIntro": MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Kalium. Μόλις λάβετε BANANO, οι συναλλαγές θα εμφανιστούν ως εξής:"),
        "exampleCardLittle": MessageLookupByLibrary.simpleMessage("Λίγα"),
        "exampleCardLot": MessageLookupByLibrary.simpleMessage("Πολλά"),
        "exampleCardTo": MessageLookupByLibrary.simpleMessage("προς κάποιον/α"),
        ...
        "logoutDetail": MessageLookupByLibrary.simpleMessage(
            "Η αποσύνδεση θα διαγράψει το seed σας και όλα τα δεδομένα σχετικά με το Kalium από αυτή τη συσκευή. Εάν δεν έχετε δημιουργήσει αντίγραφο ασφαλείας του seed σας, δεν θα έχετε ποτέ ξανά πρόσβαση στα χρήματά σας."),
        "logoutReassurance":
            MessageLookupByLibrary.simpleMessage("Εφόσον έχετε δημιουργήσει αντίγραφο ασφαλείας του seed σας, δεν έχετε τίποτα να ανησυχείτε."),
        ...
        "pinCreateTitle": MessageLookupByLibrary.simpleMessage("Δημιουργήστε ένα pin 6 ψηφίων"),
        ...
        "seedBackupInfo": MessageLookupByLibrary.simpleMessage(
            "Παρακάτω είναι το seed του πορτοφολιού σας. Είναι σημαντικό να δημιουργήσετε αντίγραφα ασφαλείας του seed σας και να μην τα αποθηκεύσετε ποτέ ως απλό κείμενο ή ως στιγμιότυπο οθόνης."),
        ...
        "sendError": MessageLookupByLibrary.simpleMessage("Παρουσιάστηκε σφάλμα. Δοκιμάστε ξανά αργότερα."),
        ...
        "welcomeText": MessageLookupByLibrary.simpleMessage(
            "Καλωσήρθατε στο Kalium. Για να συνεχίσετε, μπορείτε να δημιουργήσετε ένα νέο πορτοφόλι ή να εισάγετε ένα υπάρχον."),
