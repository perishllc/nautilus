class Dimens {
  ...
  static const BUTTON_BOTTOM_EXCEPTION_DIMENS = [28.0, 16.0, 28.0, 0.0];
  ...
  static const BUTTON_COMPACT_LEFT_DIMENS = [28.0, 0.0, 7.0, 0.0];
  static const BUTTON_COMPACT_RIGHT_DIMENS = [7.0, 0.0, 28.0, 0.0];
}
