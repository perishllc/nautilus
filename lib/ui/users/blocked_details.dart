...
class BlockedDetailsSheet extends StatefulWidget {
  const BlockedDetailsSheet({super.key, required this.blocked, this.documentsDirectory});

  final User blocked;
  final String? documentsDirectory;

  @override
  BlockedDetailsSheetState createState() => BlockedDetailsSheetState();
}

class BlockedDetailsSheetState extends State<BlockedDetailsSheet> {
              ...
              children: <Widget>[
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      AppDialogs.showConfirmDialog(
                          ...
                          Z.of(context).removeBlockedConfirmation.replaceAll('%1', widget.blocked.getDisplayName()!),
                          CaseChange.toUpperCase(Z.of(context).yes, context), () {
                        sl.get<DBHelper>().unblockUser(widget.blocked).then((bool deleted) {
                          if (deleted) {
                            // Delete image if exists
                            EventTaxiImpl.singleton().fire(BlockedRemovedEvent(user: widget.blocked));
                            EventTaxiImpl.singleton().fire(BlockedModifiedEvent(user: widget.blocked));
                            UIUtil.showSnackbar(
                                Z.of(context).blockedRemoved.replaceAll("%1", widget.blocked.getDisplayName()!), context);
                ...
                Container(
                  ...
                  child: TextButton(
                    ...
                    // splashColor: StateContainer.of(context).curTheme.text15,
                    onPressed: () async {
                      await UIUtil.showAccountWebview(context, widget.blocked.address);
                    },
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: combineLists(
                    getAliases(context, widget.blocked),
                    [
                      // Contact Name container
                      if (widget.blocked.nickname != null && widget.blocked.nickname!.isNotEmpty)
                        Container(
                          width: double.infinity,
                          margin: EdgeInsets.only(
                            left: MediaQuery.of(context).size.width * 0.105,
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: UIUtil.threeLineAddressText(context, widget.blocked.address!,
                              type: _addressCopied
                      ...
                      if (widget.blocked.aliases != null)
                        Container(
