...
class _ReceiveSheetStateState extends State<ReceiveSheet> {
          ...
          children: <Widget>[
            ...
            Column(
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    AppButton.buildAppButton(context, AppButtonType.PRIMARY, AppLocalization.of(context).request,
                      ...
                      if (_amountController!.text.isEmpty || _amountController!.text == "0") {
                        ...
                        if (_localCurrencyMode) {
                          amountRaw = NumberUtil.getAmountAsRaw(sanitizedAmount(
                              _localCurrencyFormat, _convertLocalCurrencyToLocalizedCrypto(_amountController!.text)));
                        } else {
                          if (!mounted) return;
                ...
                Row(
                  children: <Widget>[
                    AppButton.buildAppButton(context, AppButtonType.PRIMARY_OUTLINE,
                        AppLocalization.of(context).showAccountQR, Dimens.BUTTON_BOTTOM_DIMENS, onPressed: () async {
  ...
  Future<bool> _validateRequest({bool isRequest = false}) async {
    ...
    if (isValid) {
      ...
      if ((isRequest || (_memoController!.text.isNotEmpty && _addressController!.text.isNotEmpty)) &&
