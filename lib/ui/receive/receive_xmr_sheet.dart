...
class ReceiveXMRSheet extends StatefulWidget {
  const ReceiveXMRSheet({required this.localCurrency, this.address, this.qrWidget}) : super();
  ...
  @override
  ReceiveXMRSheetState createState() => ReceiveXMRSheetState();
}

class ReceiveXMRSheetState extends State<ReceiveXMRSheet> {
                                ...
                                _capturePng().then((Uint8List? byteData) {
                                  if (byteData != null) {
                                    f.writeAsBytes(byteData).then((File file) {
                                      ...
                                      Share.shareFiles([filePath], text: widget.address);
                                    });
                                  } else {
