...
class RegisterNanoToCompleteSheet extends StatefulWidget {
  final String? amountRaw;
  final String? destination;
  final String? contactName;
  final String? localAmount;

  RegisterNanoToCompleteSheet({this.amountRaw, this.destination, this.contactName, this.localAmount}) : super();

  _RegisterNanoToCompleteSheetState createState() => _RegisterNanoToCompleteSheetState();
}

class _RegisterNanoToCompleteSheetState extends State<RegisterNanoToCompleteSheet> {
  @override
  void initState() {
    super.initState();
  }
