...
class HandoffCompleteSheet extends StatefulWidget {
  ...
  HandoffCompleteSheet({required this.amountRaw, required this.destination, this.contactName, this.localAmount, this.memo = ""}) : super();

  _HandoffCompleteSheetState createState() => _HandoffCompleteSheetState();
}

class _HandoffCompleteSheetState extends State<HandoffCompleteSheet> {
  @override
  void initState() {
    super.initState();
  }
