...
class _AppChangeRepresentativeSheetState extends State<AppChangeRepresentativeSheet> {
  ...
  Widget _buildSingleRepresentative(N2Node rep, BuildContext context, {bool isList = true}) {
    return Column(
      children: <Widget>[
        if (isList)
          Divider(
  ...
  Future<void> doChange() async {
    ...
    if (StateContainer.of(context).wallet!.openBlock == null) {
      ...
      StateContainer.of(context).checkRepGood(); // dismiss the warning if the rep is good
    ...
    return StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
      ...
      if (StateContainer.of(context).n2Nodes != null) {
        for (N2Node node in StateContainer.of(context).n2Nodes!) {
          if (node.account == StateContainer.of(context).wallet!.representative) {
            currentNode = node;
            break;
          }
        }
                            ...
                            Container(
                              ...
                              child: AutoSizeText(
                                CaseChange.toUpperCase(
                                    Z.of(context).changeRepAuthenticate, context),
                          ...
                          child: TextButton(
                            ...
                            onPressed: () {
                              AppDialogs.showInfoDialog(
                                  context, Z.of(context).repInfoHeader, Z.of(context).repInfo);
                            },
                        ...
                        Row(
                          children: <Widget>[
                            AppButton.buildAppButton(
                              ...
                              onPressed: () async {
                                if (!NanoAccounts.isValid(NonTranslatable.accountType,
                            ...
                            AppButton.buildAppButton(
                              ...
                              onPressed: () {
                                Sheets.showAppHeightEightSheet(
                                    context: context,
                                    widget: ChangeRepManualSheet(TextEditingController()));
                              },
                            ),
                          ],
                        ),
