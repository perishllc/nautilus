...
class NodeDetailsSheet {
  ...
  Future<bool> _onWillPop() async {
    ...
    if (originalName != _nameController!.text && _nameController!.text.trim().isNotEmpty && !deleted) {
      sl.get<DBHelper>().changeNodeName(node, _nameController!.text);
      node.name = _nameController!.text;
      EventTaxiImpl.singleton().fire(NodeModifiedEvent(node: node));
    }
    return true;
  }
                                        ...
                                        : TextButton(
                                            ...
                                            onPressed: () {
                                              AppDialogs.showConfirmDialog(
                                                ...
                                                // Remove account
                                                deleted = true;
                                                sl.get<DBHelper>().deleteNode(node).then((int id) {
